...
Apart from this, test scripts (sprite4-\*test) are also included. 
...
The [SPRITE4](https://github.com/vasupsu/sprite4) repository includes a toy dataset NA12891. Sample test script sprite4\_test and sprite4\_parsnip\_test are simple test scripts for performing serial runs using this dataset. sprite4\_test executes MAP-SAMPA-VARCALL pipeline whereas sprite4\_parsnip\_test executes MAP-SAMPA-PARSNIP-VARCALL pipeline shown in above Figure. Both these pipelines output the same set of variants for this dataset.These are BASH scripts and don't require any arguments.
