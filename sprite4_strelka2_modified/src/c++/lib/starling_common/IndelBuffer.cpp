...
//    std::cout << "PRINT call addIndelObservation 3\n";
...
//        std::cout << "PRINT reads supporting indel/total reads " << tier1ReadSupportCount << "/" << totalReadCount << std::endl;
...
isCandidateIndelImplTest(
    ...
    const IndelData& indelData) const
{
//    std::cout << "PRINT isCandidateIndelImplTest " << indelKey.pos ;
...
//        std::cout << " T1\n";
    ...
    if (_opt.is_short_haplotyping_enabled && (! indelData.isConfirmedInActiveRegion)) 
    {
//        std::cout << " F1\n";
        return false;
    }
    ...
    {
        if (not isCandidateIndelImplTestSignalNoise(indelKey, indelData)) 
        {
//            std::cout << " F2\n";
            return false;
        }
    ...
    {
        if (not isCandidateIndelImplTestWeakSignal(indelData)) 
        {
//            std::cout << " F3\n";
            return false;
        }
...
//        std::cout << " F4\n";
    ...
    if (_maxCandidateDepth > 0.)
    {
        ...
        if (estimatedLocusDepth > _maxCandidateDepth) 
        {
//            std::cout << " F5\n";
            return false;
        }
