...
bam_streamer(
    ...
    : _is_record_set(false),
      ...
      curTid(-1), curData(NULL), curBamRec (NULL), totalSegments(500), numOutChunks(0), numMaxChunks(0), maxChunkSize(0), aebaib_prefix("/i3c/sparse/vxr162/journal_paper/miniconda2/pkgs/sprite4-4.0-py27_0/opFiles/tmp2N_0"), startFile (-1), cur_aeb_rec (-1), total_aeb_rec (-1), endFile (-1), cur_aib_rec (-1), total_aib_rec (-1),
