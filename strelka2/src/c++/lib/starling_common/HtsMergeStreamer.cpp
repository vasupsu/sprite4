...
next()
{
//    std::cout << "HtsMergeStreamer::next1 begin " << _isStreamBegin << " end " << _isStreamEnd << std::endl;
...
//    std::cout << "HtsMergeStreamer::next2 begin " << _isStreamBegin << " end " << _isStreamEnd << std::endl;
