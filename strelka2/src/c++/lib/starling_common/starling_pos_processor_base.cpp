    ...
    const unsigned sampleIndex)
{
    ...
    try
    {
        ...
        {
//            std::cout << "PRINT call insertIndel 1\n";
            getActiveRegionReadBuffer(sampleIndex).insertIndel(obs);
        }
        else
        {
//            std::cout << "PRINT call addIndelObservation 5\n";
...
{
#if 0
    log_os << "PRINT pos,stage_no: " << pos << " " << stage_no << "\n";
#endif
    ...
    else if (stage_no==STAGE::POST_ALIGN)
    {
        ...
        {
//            std::cout << "PRINT call variants: " << pos << " reportable/preceding reportable " << isPosReportable << "/" << isPosPrecedingReportable <<std::endl;
...
//            if (isCandidate)
//                std::cout << "PRINT isCandidate " << isCandidate << std::endl;
